...
const cakeSlideCode = `function CakeSlide({ onNext }) {
  ...
  return (
    ...
    >
      ...
      {/* Shooting Stars background (active after balloons pop) */}
      {phase !== 'balloons' && (
...
content = content.replace(/function CakeSlide\(\{(.|\n)*?function FinaleSlide/m, cakeSlideCode + '\n\nfunction FinaleSlide');

fs.writeFileSync('src/App.jsx', content);
console.log("CakeSlide updated successfully.");
